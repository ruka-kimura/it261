...
if (!empty($name) && !empty($email) && !empty($amount) && !empty($currency) && ($bank != NULL) && ($dollars < 1000)) {
    echo '
    <div class="box">
    <p><b>I am NOT happy, because I have $'.$dollars.' American dollars!</p></b>
    <iframe width="877" height="493" src="https://www.youtube.com/embed/JGk42E2eSlU" title="Minions Jingle Bells X-Mas Song" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
';
} elseif (!empty($name) && !empty($email) && !empty($amount) && !empty($currency) && ($bank != NULL) && ($dollars >= 1000 && $dollars < 2000)) {
    echo '
    <div class="box">
    <p><b>I am happy, because I have $'.$dollars.' American dollars!</p></b>
    <iframe width="877" height="493" src="https://www.youtube.com/embed/2vHB9MEp4nU" title="Y.M.C.A | Despicable Me 2 | Screen Bites" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
';
} elseif (!empty($name) && !empty($email) && !empty($amount) && !empty($currency) && ($bank != NULL)) {
    echo '
    <div class="box">
    <h2><b>I am REALLY happy, because I have $'.$dollars.' American dollars!</h2></b>
    <iframe width="877" height="493" src="https://www.youtube.com/embed/MOWDb2TBYDg" title="HAPPY - Pharrell Williams (feat. Minions)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
';
